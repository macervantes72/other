...
#import DM_DLL_PATH no_namespace \
...
class TheWorld : public COleDispatchDriver
{
public:
	TheWorld(){} // 调用 COleDispatchDriver 默认构造函数
	TheWorld(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	TheWorld(const TheWorld& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
